...
class Role extends StackableObject
{
     ...
     * 
     * @see    Cscfa\Bundle\CSManager\CoreBundle\Util\Manager\RoleManager::roleExists()
     * @return Role
     */
     ...
     * 
     * @see    Cscfa\Bundle\CSManager\CoreBundle\Util\Manager\RoleManager::hasCircularReference()
