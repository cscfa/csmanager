...
class UserBuilderTest extends WebTestCase
{
    ...
    public function testBuilder()
    {
        ...
        $this->assertTrue($user->setEmail("matthieu.vallance@cscfa.fr"));
        $this->assertFalse($user->setEmail("invalid"));
        $this->assertTrue($user->getEmail() === "matthieu.vallance@cscfa.fr");
        ...
        $this->assertTrue($user->getLastError() === $user::EXPIRATION_DATE_BEFORE_NOW);
        $this->assertFalse($user->setCredentialsExpireAt($dateNow));
        $this->assertTrue($user->getLastError() === $user::EXPIRATION_DATE_BEFORE_NOW);
