...
class LinksController extends Controller
{
    ...
    public function addSourceAction(Project $project)
    {
        ...
        $form = $this->createFormBuilder($link)
            ->setAction(
                $this->generateUrl(
                    'cscfa_cs_manager_project_ajaxTarget_link_add',
                    array(
    ...
    public function removeSourceAction(Project $project, ProjectLink $link)
    {
        ...
        ->setAction($this->generateUrl('cscfa_cs_manager_project_ajaxTarget_link_remove', array(
            'project' => $project->getId(),
            'link' => $link->getId(),
