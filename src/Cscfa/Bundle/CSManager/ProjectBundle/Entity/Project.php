...
class Project
{
     ...
     *      type="datetime",
     *      nullable=false,
     *      name="csmanager_Project_created",
     *      options={"comment":"Project date of creation"}
     * )
     */
    protected $created;
     ...
     *      type="datetime",
     *      nullable=true,
     *      name="csmanager_Project_updated",
     *      options={"comment":"Project date of last update"}
     * )
     */
    protected $updated;
     ...
     * @ORM\Column(
     *      type="boolean",
     *      options={"default" = false, "comment":"The Project deletion state"},
     *      nullable=false,
     *      name="csmanager_Project_deleted"
     * )
     */
    protected $deleted;
     ...
     *      type="string",
     *      length=255,
     *      options={"comment":"The Project name"},
     *      nullable=false,
     *      unique=true,
     *      name="csmanager_Project_name"
     * )
     * @Assert\NotBlank()
     */
    protected $name;
     ...
     * @ORM\JoinTable(
     *      name="tk_csmanager_project_join_tags",
     *      joinColumns={
     *          @ORM\JoinColumn(
     *              name="csmanager_project_id",
     *              referencedColumnName="csmanager_Project_id"
     *          )
     *      },
     *      inverseJoinColumns={
     *          @ORM\JoinColumn(
     *              name="csmanager_tag_id",
     *              referencedColumnName="csmanager_ProjectTag_id"
     *          )
     *      }
     *  )
     */
     ...
     * @ORM\Column(
     *      type="text",
     *      options={"comment":"The Project short description"},
     *      nullable=true,
     *      name="csmanager_Project_summary"
     * )
     */
    protected $summary;
