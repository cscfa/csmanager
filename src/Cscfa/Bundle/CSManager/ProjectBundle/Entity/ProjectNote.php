...
class ProjectNote
{
     ...
     *      type="datetime",
     *      nullable=false,
     *      name="csmanager_ProjectNote_created",
     *      options={"comment":"ProjectNote date of creation"}
     * )
     */
    protected $created;
     ...
     *      type="datetime",
     *      nullable=true,
     *      name="csmanager_ProjectNote_updated",
     *      options={"comment":"ProjectNote date of last update"}
     * )
     */
    protected $updated;
     ...
     * @ORM\Column(
     *      type="boolean",
     *      options={"default" = false, "comment":"The ProjectNote deletion state"},
     *      nullable=false,
     *      name="csmanager_ProjectNote_deleted"
     * )
     */
    protected $deleted;
     ...
     * @ORM\Column(
     *      type="text",
     *      options={"comment":"The ProjectNote content"},
     *      nullable=false,
     *      name="csmanager_ProjectNote_description"
     * )
     */
    protected $content;
