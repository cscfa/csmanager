...
class UseCase implements TaskCaseInterface
{
     ...
     *      type="datetime",
     *      nullable=false,
     *      name="csmanager_UseCase_created",
     *      options={"comment":"UseCase date of creation"}
     * )
     *
     * @var \DateTime
     */
     ...
     *      type="datetime",
     *      nullable=true,
     *      name="csmanager_UseCase_updated",
     *      options={"comment":"UseCase date of last update"}
     * )
     *
     * @var \DateTime
     */
     ...
     * @ORM\JoinTable(
     *      name="tk_csmanager_useCase_join_tags",
     *      joinColumns={
     *          @ORM\JoinColumn(
     *              name="csmanager_UseCase_id",
     *              referencedColumnName="csmanager_UseCase_id"
     *          )
     *      },
     *      inverseJoinColumns={
     *          @ORM\JoinColumn(
     *              name="csmanager_UseCaseTag_id",
     *              referencedColumnName="csmanager_UseCaseTag_id"
     *          )
     *      }
     * )
     *
     ...
     *      unique=true,
     *      nullable=false,
     *      name="csmanager_UseCase_name",
     *      options={"comment":"UseCase name"}
     * )
     *
     * @var string
     */
     ...
     *      type="text",
     *      nullable=true,
     *      name="csmanager_UseCase_description",
     *      options={"comment":"UseCase description"}
     * )
     *
     * @var string
     */
     ...
     * @ORM\JoinTable(
     *      name="tk_csmanager_useCase_join_childs",
     *      joinColumns={
     *          @ORM\JoinColumn(
     *              name="csmanager_UseCase_id",
     *              referencedColumnName="csmanager_UseCase_id"
    ...
    public function __construct(
        ...
        // The project
        ProjectOwner $creator = null,
        // The creator
        TaskStatusInterface $status = null,
        // The status
        ArrayCollection $tag = null,
        // The tag collection
        ArrayCollection $taskChilds = null,
        // The task childs collection
