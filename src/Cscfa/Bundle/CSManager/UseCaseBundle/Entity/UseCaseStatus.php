...
class UseCaseStatus implements TaskStatusInterface {
     ...
     * The UseCase id
     * 
     * @ORM\Column(type="guid", nullable=false, name="csmanager_UseCaseStatus_id", options={"comment":"UseCaseStatus id"})
     * @ORM\Id
     ...
     * The UseCase name
     *
     * @ORM\Column(type="string", length=255, unique=true, nullable=false, name="csmanager_UseCaseStatus_name", options={"comment":"UseCaseStatus name"})
     * @var string
     */
    protected $name;
     ...
     * 
     * @ORM\Column(type="text", nullable=true, name="csmanager_UseCaseStatus_description", options={"comment":"UseCaseStatus description"})
     * @var string
     */
