...
class AddEntityChainTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testProcessWithTrueObject()
    {
        ...
        $this->assertNull(
            $data->testProperty,
            "The AddEntityChain mustn't inject data into property if no one setter exist and data to inject" +
            'not match the needles'
        );
    }
    ...
    public function testProcessWithRequestObject()
    {
        ...
        $this->assertSame(
            $this->routedEntity,
            $data->testProperty,
            'The AddEntityChain must inject the routed object into property if the data ' +
            "injected match 'currentRequest'"
        );
    }
    ...
    public function testProcessWithRepositoryObject()
    {
        ...
        $this->assertSame(
            $entity,
            $data[self::SUPPORTED_PROPERTY_NAME],
            'The AddEntityChain must inject the repository finded object by method if the' +
            'data injected is an id and entity exist'
        );
        ...
        $this->assertSame(
            $entity,
            $data->testProperty,
            'The AddEntityChain must inject the repository finded object into property if' +
            'the data injected is an id and entity exist'
        );
        ...
        $this->assertFalse(
            array_key_exists(self::SUPPORTED_PROPERTY_NAME, $data),
            "The AddEntityChain mustn't inject the repository finded object by method if" +
