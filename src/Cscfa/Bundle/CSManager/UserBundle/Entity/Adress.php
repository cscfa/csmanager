...
class Adress
{
     ...
     * 
     * @var string
     * @ORM\Column(type="string", length=255, options={"comment":"The adress receiver referer"}, nullable=false, name="csmanager_adress_referer")
     */
    protected $referer;
     ...
     * 
     * @var string
     * @ORM\Column(type="string", length=255, options={"comment":"The adress"}, nullable=false, name="csmanager_adress_text")
     */
    protected $adress;
     ...
     * 
     * @var string
     * @ORM\Column(type="string", length=255, options={"comment":"The adress complement"}, nullable=true, name="csmanager_adress_complement")
     */
     ...
     * 
     * @var string
     * @ORM\Column(type="string", length=255, options={"comment":"The adress town"}, nullable=false, name="csmanager_adress_town")
     */
    protected $town;
     ...
     * 
     * @var integer
     * @ORM\Column(type="integer", options={"comment":"The adress postal code"}, nullable=false, name="csmanager_adress_postal_code")
     */
     ...
     * 
     * @var string
     * @ORM\Column(type="string", length=255, options={"comment":"The adress country"}, nullable=false, name="csmanager_adress_country")
     */
    protected $country;
     ...
     * code
     * 
     * @return integer - the address postal code
     */
     ...
     * 
     * @param integer $postalCode - the address postal code
     * 
     * @return Adress - the current instance
     */
