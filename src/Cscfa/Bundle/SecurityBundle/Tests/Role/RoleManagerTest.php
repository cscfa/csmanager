...
class RoleManagerTest extends WebTestCase
{
    ...
    public function testNewInstance()
    {
        ...
        $this->assertInstanceOf("Cscfa\Bundle\SecurityBundle\Util\Builder\RoleBuilder", $roleBuilder, "The result of RoleManager get new instance is not an instance of RoleBuilder");
    ...
    public function testInstanceConvertion()
    {
        ...
        $this->assertInstanceOf("Cscfa\Bundle\SecurityBundle\Util\Builder\RoleBuilder", $roleConverted, "The result of RoleManager::convertInstance is not a RoleBuilder instance");
        if ($roleConverted instanceof RoleBuilder) {
            $this->assertInstanceOf("Cscfa\Bundle\SecurityBundle\Entity\Role", $roleConverted->getRole(), "The result of RoleBuilder::getRole() is not an instance of Role for RoleManager::convertInstance RoleBuilder result");
            $this->assertInstanceOf("Cscfa\Bundle\SecurityBundle\Entity\StackUpdate", $roleConverted->getStackUpdate(), "The result of RoleBuilder::getStackUpdate() is not a StackUpdate instance for RoleManager::convertInstance RoleBuilder result");
        }
    }
