...
class ColoredStringFactory implements CommandColorInterface, CommandOptionInterface
{
    ...
    public function __toString()
    {
        ...
        if ($this->foreground !== null || $this->background !== null || $this->option !== null) {
            ...
            $fg = ($this->foreground !== null ? 'fg=' . $this->foreground : '');
            if ($fg !== '') {
                $start .= $fg . ($this->background !== null || $this->option !== null ? ';' : '');
                $end .= $fg . ($this->background !== null || $this->option !== null ? ';' : '');
            }
            
            $bg = ($this->background !== null ? 'bg=' . $this->background : '');
            if ($bg !== '') {
                $start .= $bg . ($this->option !== null ? ';' : '');
                $end .= $bg . ($this->option !== null ? ';' : '');
            }
