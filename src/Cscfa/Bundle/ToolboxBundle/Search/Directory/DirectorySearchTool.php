...
class DirectorySearchTool
{
     ...
     * @throws NotDirectoryException      if the filesystem element appoint by the $directory parameter exist but is not a directory
     * @return void
     */
     ...
     * @param boolean $recursive   The recursive state
