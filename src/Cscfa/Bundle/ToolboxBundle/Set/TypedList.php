...
class TypedList extends ListSet
{
    ...
    protected function supportClass($class)
    {
        if (is_string($class) && $class === $this->type) {
            return true;
        } elseif (is_object($class) && get_class($class) === $this->type) {
            return true;
        }
    ...
    public function get($element)
    {
        ...
        } elseif (!is_object($element) && in_array($element, $this->container)) {
    ...
    public function remove($element)
    {
        if (in_array($element, $this->container)) {
            ...
            return $element;
        } elseif (!is_object($element) && isset($this->container[$element])) {
