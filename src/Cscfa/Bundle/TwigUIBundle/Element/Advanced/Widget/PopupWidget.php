...
class PopupWidget extends Widget
{
     ...
     * @param bool   $closeable The widget closeable state. (true as default)
     * @param bool   $displayed The widget default display state. (false as default)
     */
     ...
     * closeable state.
     *
     * @param bool $closeable The current widget closeable state
     *
     * @return PopupWidget
     */
     ...
     * displayed state.
     *
     * @param bool $displayed The displayed state.
     *
     * @return PopupWidget
     */
