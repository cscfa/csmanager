...
/**
 * AbstractTopLevelModule.
 *
 * The AbstractTopLevelModule is used to
 * define the process of the top level
 * modules methods.
 *
 * @category Abstract
 *
 ...
 * @link     http://cscfa.fr
 */
abstract class AbstractTopLevelModule extends AbstractModule
{
    /**
     * Constructor.
     *
    ...
    {
        $environment->getTwigHierarchy()->startHierarchy();
